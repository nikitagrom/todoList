 ...
 */
case class Task(id:Long,name:String,project:String,isDone:Boolean,dueDate:String,folder:String)
object Task{
  val task = {
    get[Long]("id")~
    get[String]("name")~
  ...
  def create(name:String,project: Project,isDone:Boolean,dueDate:String,folder:String)={
